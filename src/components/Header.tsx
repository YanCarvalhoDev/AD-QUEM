...
export default function Header({ isDarkPage = false }: HeaderProps) {
  ...
  const menuItems = [
    { name: "Início", id: "home", href: INTERNAL_LINKS.home },
    {
      name: "Serviços",
      id: "services",
  ...
  const Icons = {
    ...
    // Ícone de Autores: 3 usuários (grupo/comunidade) sem a caixa de documento
    Author: () => (
      <svg
        xmlns="http://w3.org"
        width="28"
      ...
      >
        ...
        <path d="M7 3.13a4 4 0 0 0 0 7.75" />
      </svg>
    ),
    // Calendar: () => (
    //   <svg
  ...
  const insightsData = [
    ...
    {
      title: "Artigos",
      desc: "Direito e Inovação",
      icon: <Icons.FileText />,
      href: "/blog",
    },
    {
      title: "Autores",
      desc: "Parceiros Oficiais",
      icon: <Icons.Author />,
      href: "/autores",
    },
    // {
  ...
  return (
    <>
      ...
      >
        <div
          className={`container mx-auto px-6 flex justify-between items-center transition-all duration-500 ${showActiveState ? "py-4" : "py-5"}`}
        >
          {/* <a
            href="/"
          ...
          {/* <a href="/" className="flex items-center">
            <div
              className={`h-10 w-32 transition-all duration-500 ${
                showActiveState
                  ? "logo-gold-gradient" // Fica Dourado
                  : isDarkPage
                    ? "bg-white" // Fica Branco sólido (usando mask também)
                    : "logo-gold-gradient lg:bg-white"
              }`}
              style={{
                WebkitMaskImage: "url('/AQ_Ad_Quem_logo.png')",
                maskImage: "url('/AQ_Ad_Quem_logo.png')",
            ...
            >
              <div className="container mx-auto px-20 py-12">
                ...
                <div className="mt-12 pt-8 border-t border-gray-100">
                  ...
                  <a
                    href="/blog"
                    className="flex items-center gap-2 text-[13px] font-bold text-[#005F6B] border border-[#005F6B] px-4 py-2 rounded-full hover:bg-[#005F6B] hover:text-white transition-all w-fit"
                  >
                    Notícias e Insights <ChevronRight size={14} />
                  </a>
                </div>
