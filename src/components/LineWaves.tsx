...
export default function LineWaves({
  ...
  // Sync props to uniforms using a separate effect to avoid re-mounting
  useEffect(() => {
    if (programRef.current) {
      const program = programRef.current;
      const rotationRad = (rotation * Math.PI) / 180;
      program.uniforms.uSpeed.value = speed;
      program.uniforms.uInnerLines.value = innerLineCount;
      program.uniforms.uOuterLines.value = outerLineCount;
      program.uniforms.uWarpIntensity.value = warpIntensity;
      program.uniforms.uRotation.value = rotationRad;
      program.uniforms.uEdgeFadeWidth.value = edgeFadeWidth;
      program.uniforms.uColorCycleSpeed.value = colorCycleSpeed;
      ...
      program.uniforms.uEnableMouse.value = enableMouseInteraction;
    }
  }, [
    speed,
    innerLineCount,
  ...
  useEffect(() => {
    ...
    // Efficiency: devicePixelRatio capped at 2
    ...
    if (enableMouseInteraction) {
      ...
      gl.canvas.addEventListener("touchstart", (e) => handleTouchMove(e), {
        passive: true,
      });
      gl.canvas.addEventListener("touchmove", (e) => handleTouchMove(e), {
        passive: true,
      });
    }

    // Efficiency: IntersectionObserver
