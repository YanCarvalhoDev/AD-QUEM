      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-sandstone/80 leading-relaxed text-lg font-light">
              <p>
                A Ad Quem foi fundada por {""}
                <strong className="text-sandstone/100">
                  Yan Carvalho, Engenheiro da Computação
                </strong>
                , a partir de uma visão simples: a autoridade construída por uma
                banca ao longo de sua trajetória precisa ser traduzida
                corretamente para o ambiente digital.
              </p>
              <p>
                Seu trabalho combina engenharia, estratégia digital e
                arquitetura de informação para desenvolver presenças digitais
                capazes de representar a reputação, o conhecimento e o
                posicionamento de organizações jurídicas.
              </p>
              <p>
                A atuação da Ad Quem vai além do desenvolvimento de websites.
                Cada projeto é pensado como parte de uma estrutura maior de
                autoridade digital, da experiência institucional à descoberta,
                do conteúdo à infraestrutura tecnológica..
              </p>
            </div>
            <div className="mt-12 pt-12 border-t border-gold-pale/10">
              <div className="text-2xl font-serif text-gold-pale">
              ...
              <div className="text-xs uppercase tracking-widest text-sandstone/40 mt-1">
                Founder · Engenheiro da Computação
              </div>
            </div>
          </div>
        </div>
